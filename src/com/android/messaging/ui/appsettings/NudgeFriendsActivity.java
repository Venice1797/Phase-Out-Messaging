...
public class NudgeFriendsActivity extends BugleActionBarActivity {
    ...
    private static final String[] AUTO_REPLY_TEMPLATES = {
        ...
        "<Auto Reply: Messaging on my phone is partially disabled due to privacy and security risks. Please call me, email me, or contact me on %s, please include your contact info, and the purpose in reaching out to me.>",
